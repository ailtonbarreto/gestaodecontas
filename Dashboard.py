...
grafico_barras = px.bar(dfgrafico,x="Valor",y="CATEGORIA",orientation="h",title=f"Despesas de {filtro_mes} de {filtro_ano}",color_discrete_sequence=["#941b0c"],color="Status")
